...
const Member = (props) => {
    ...
    useEffect(() => {
        ...
        setAnimation("")
        if (!props.isCorrect && props.isUser) {
            console.log(props.key)
            setTimeout(() => { setAnimation("animate__animated animate__tada ")}, 10);
        }

    }, [props.member])

    return (
        <div className={`bg-white w-full flex items-center px-1 my-1 rounded-xl bg-gray-50   ${animation}`}>
